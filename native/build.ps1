# builds native/vlc.c into <lib>/native/bin/vlc-windows.hdll (the hashlink native ext heapvlc.HeapVLC /
...
# 3. compile vlc.c -> native/bin/vlc-windows.hdll
...
$outHdll = Join-Path $outDir "vlc-windows.hdll"
$cmd = @"
